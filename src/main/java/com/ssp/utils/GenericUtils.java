...
public class GenericUtils {
  ...
  public static String setDate(String days, int nofOfDays, int noOfYear) throws ParseException {
   ...
   * 
   * @param element - the input field you need the value/text of
   * @param driver -   // format - "dd/MM/yyyy HH:mm:ss"
   * @return text of the input's value
   */
  public static String getCurrentDate(String format, WebDriver driver) {	 
    String sDataToBeReturned = null;
    SimpleDateFormat formatter = new SimpleDateFormat(format);  
    Date date = new Date();  
    sDataToBeReturned =  formatter.format(date);    
    return sDataToBeReturned;
  }
